...
Container getExperience(
    BuildContext context, double width, AboutScreenAnimation animation) {
  return Container(
    ...
    child: FittedBox(
      ...
      child: Column(
        children: [
          SlideTransition(
            position: animation.text1Offset,
            child: Column(
              ...
              child: Row(
                ...
                children: [
                  Row(
                    children: [
                      Text(
                        animation.number1.value.ceil().toString(),
                        style: TextStyle(
                            fontSize: 70,
                  ...
                  Row(
                    children: [
                      Text(
                        animation.number2.value.ceil().toString(),
                        style: TextStyle(
                            fontSize: 70,
                            fontWeight: FontWeight.w600,
                            color: Theme.of(context).accentColor),
          ...
          SlideTransition(
            position: animation.text3Offset,
            child: Text(
...
Widget getContactCard(BuildContext context, double width, Function setState,
    AboutScreenAnimation animation) {
  return SlideTransition(
    position: animation.contactOffset,
    child: Container(
      width: screenWidth(context) * width,
